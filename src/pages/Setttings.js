...
//         //       </div>
//         //     );
//         // Add these state variables at the top of your Settings component
...
//           setError(null);
//           try {
//             const token = localStorage.getItem("authToken"); // أو أي طريقة تستخدمها لحفظ التوكن
...
//         // Add useEffect to fetch orders when the orders tab is active
//         useEffect(() => {
//           if (activeTab === "orders") {
//             fetchUserOrders();
//           }
...
//       // Replace the "orders" case in your renderContent() function with this:
//       case "orders":
//         return (
