...
import {
  ...
  FaMoon,
  FaBoxOpen,
  FaQuestionCircle, FaShieldAlt, FaFileContract, FaLifeRing,
  FaPlus, FaMinus,FaShoppingCart,FaBell,
  FaStore,
  FaTools,
  FaRegFileAlt
} from "react-icons/fa";
...
const Settings = () => {
  const [selectedCountryAbbreviation, setSelectedCountryAbbreviation] = useState("");
  const fileInputRef = useRef(null);
  const [profileImage, setProfileImage] = useState(null);
  const [activeTab, setActiveTab] = useState("account");
  const { t } = useTranslation();
  const { i18n } = useTranslation(); // استيراد دالة الترجمة
  console.log('Language changed to: ', i18n.language); // افحص اللغة
  const [openIndex, setOpenIndex] = useState(null);
  const navigate = useNavigate();
  const [activeCard, setActiveCard] = useState("buyers");
  ...
  const handleCardClick = (card) => {
    ...
    setOpenIndexes([]); // كل ما أختار كارد جديد، يقفل اللي قبله
  };
        ...
        case "language":
            return (
              <div className="max-w-2xl">
                <h1 className="text-3xl font-bold text-gray-800 mb-6">Language & Appearance</h1>
...
/>
            ...
            case "shipping":
              return (
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onChange={(selectedOption) => {
                            // Set the selected country abbreviation dynamically
                            setSelectedCountryAbbreviation(selectedOption?.value);
                          }}
                        />
                      </div>
                      <div>
                ...
                case "orders":
                    return (
                      <div className="max-w-2xl text-center text-red-800 pt-16">
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 flex flex-col">
        ...
        >
          <section>
            ...
            <p>
              This platform is created to connect users for buying and selling
              products or services. Our goal is to provide a safe and efficient
          ...
          <section>
            ...
            <p>
              ...
              Any content shared must be lawful, respectful, and truthful.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Content on this site may not be copied, resold, or redistributed
              without permission. It's only allowed for personal or authorized
              use.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Illegal use, site manipulation, spamming, fraud, or hacking are
              strictly forbidden.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content, logos, and trademarks belong to the platform unless
              stated otherwise. Reproduction without consent is not allowed.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              transaction. The platform provides a medium, not a guarantee.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We are not liable for external transactions, third-party errors,
...
<ul className="space-y-6 text-sm">
  {navItem("account", <FaUser />, "Account Information", "Manage your name, email, and password")}
  {navItem("language", <FaLanguage />, "Language & Appearance", "Change language or switch to dark mode")}
  {navItem("shipping", <FaMapMarkerAlt />, "Shipping Information", "Update your delivery address and contact info")}
  {navItem("orders", <FaClipboardList />, "Order History", "Review your recent orders")}

  {/* New Static Pages */}
  {navItem("FAQ", <FaQuestionCircle />, "FAQ", "Common questions and answers")}
  {navItem("privacy", <FaShieldAlt />, "Privacy Policy", "How we handle your data")}
  {navItem("terms", <FaFileContract />, "Terms & Conditions", "Rules of using the platform")}
  {navItem("help", <FaLifeRing />, "Help Center", "Get support or contact us")}
  {navItem("notifications", <FaBell />, "Notifications", "View alerts and updates")}
  ...
  <li className="mt-6">
    ...
    <p className="ml-7 text-red-200 text-xs">Sign out from your account</p>
  </li>
</ul>
      </div>
